...
.ConfigureServices((hostContext, services) =>
{
    ...
    services.AddDbContext<AdsDbContext>(options => options.UseNpgsql(configuration["ConnectionStrings:ClassifiedAds"], npgsql =>
    {
...
.Execute(() =>
{
    ...
    .PostgresqlDatabase(configuration.GetConnectionString("ClassifiedAds"))
